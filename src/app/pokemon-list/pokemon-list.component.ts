...
@Component({
  ...
  imports: [PokemonCardComponent, CommonModule, RouterLink, FormsModule],
  styleUrls: ['./pokemon-list.component.css'],
  providers: [PokemonUtils], // Proporcionar PokemonUtils aquí
})
export class PokemonListComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    try {
      ...
      const fetchedPokemons = await this.pokemonUtils.fetchPokemons(20, 0);
